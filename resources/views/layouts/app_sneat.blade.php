...
<html
    ...
    <head>
        ...
        <title>{{ config('app.name', 'SPP App - Pembayaran SPP Online') }}</title>
        ...
        <div class="layout-container">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ Route::is('*.home') ? 'active' : '' }}">
                    ...
                    <a href="{{ Auth::user()->role == 'ADMIN' ? route('admin.home') : route('operator.home') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">Dashboard</div>
                    </a>
                    @else
                    <a href="{{ route('wali.home') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-home-circle"></i>
                        <div data-i18n="Analytics">Dashboard</div>
                    </a>
                    @endif
